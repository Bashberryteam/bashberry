...
const FloatingWidgets = () => {
  ...
  return (
    <>
      ...
      <a
        href="https://wa.me/2347042336338"
        target="_blank"
      ...
      <div className="fixed bottom-6 right-6 z-50">
        {chatOpen && (
          <div className="mb-4 w-80 rounded-xl border border-border bg-card p-6 shadow-2xl">
            ...
            <p className="text-xs text-muted-foreground mb-4">
              Hi! 👋 We typically respond within minutes. For immediate assistance, reach us on WhatsApp.
            </p>
            <a
