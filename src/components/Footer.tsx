...
const socialLinks = [
  ...
  {
    label: "TikTok",
    url: "https://tiktok.com/@bash.berry.jnr",
    icon: (
      <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current">
  ...
  {
    label: "Facebook",
    url: "https://www.facebook.com/profile.php?id=61573904975516",
    icon: (
      <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current">
  ...
  {
    label: "X / Twitter",
    url: "https://x.com/BashBerryXpert",
    icon: (
      <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current">
